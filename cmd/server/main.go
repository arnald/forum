...
func main() {
	...
	appServices := app.NewServices(infraProviders.UserRepository, infraProviders.PostRepository, infraProviders.CommentRepository, infraProviders.VoteRepository, infraProviders.CategoryRepository)
